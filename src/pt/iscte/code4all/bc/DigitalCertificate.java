...
public class DigitalCertificate {
    public static X509CertificateHolder createTrustAnchor(KeyPair pair, String sigAlg) throws Exception {
        ...
        X509v3CertificateBuilder certificateBuilder = new JcaX509v3CertificateBuilder(x500Name, Utils.calculateSerialNumber(), Utils.calculateDate(0), Utils.calculateDate(24 *31), x500Name, pair.getPublic());
